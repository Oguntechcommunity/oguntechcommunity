...
export const regMember = ({full_name, job_title, portfolio, email_address, avatar}) => async dispatch => {
  const config = {
    headers: {
      'Content-Type': 'application/json'
    }
  }
  const body = JSON.stringify({ full_name, job_title, portfolio, email_address, avatar })
  try {
